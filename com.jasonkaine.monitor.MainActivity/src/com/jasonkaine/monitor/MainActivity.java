...
*/
    ...
    private void parse(String jString, String stats_string) throws Exception {
    	...
    	for(int i = 0; i < worker_names.length; i++) {
    		...
    		Log.d("WORKERINFO", workers_alive[i]);
    		if(Boolean.parseBoolean(workers_alive[i] ))
    			workers_on++;
    		
    		Log.d("WORKERINFO", workers_on + "");
		...
		public void run() {
			...
			TableLayout layout = (TableLayout) findViewById(R.id.worker_table);
			layout.removeAllViews();
   	    	TextView username = (TextView) findViewById(R.id.username);
   	     	...
   	     	//Current number of workers currently Mining
   	     	TextView worker = (TextView) findViewById(R.id.worker);
   	     	worker.setText("Workers On: (" + workers_on  + "/" + worker_amount + ")");
   	     	
   	     	
   	     	TableRow[] tr = new TableRow[worker_amount];
   	     	TextView[] text = new TextView[worker_amount];
